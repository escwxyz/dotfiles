...
-- See https://blingcorp.github.io/bling/#/module/scratch?id=usage
...
awful.keyboard.append_global_keybindings({
  ...
  -- Show help
  awful.key({ shift, alt }, "h", hotkeys_popup.show_help,
  ...
  -- Toggle control center --TODO change key bind
  awful.key({ mod }, 0, function()
    scratchpad:turn_off()
    control:toggle()
  end, { description = "control center", group = "Awesome" }),

  -- Toggle theme switcher -- todo F6
  awful.key({ mod }, "l", function()
    scratchpad:turn_off()
    themeswitcher:toggle()
  end, { description = "theme switcher", group = "Awesome" }),
  ...
  -- -- See https://github.com/resurrecting-open-source-projects/scrot
  -- -- Screenshot of entire screen
  -- awful.key({ mod, shift }, "s", function()
  --   local home = os.getenv("HOME")
  --   local cmd = "scrot " ..
  --       home .. "/Pictures/Screenshots/%b%d::%H%M%S.png --silent -s -e 'xclip -selection clipboard -t image/png -i $f'"
  ...
  --   local home = os.getenv("HOME")
  --   local cmd = "scrot " ..
  --       home .. "/Pictures/Screenshots/%b%d::%H%M%S.png --silent 'xclip -selection clipboard -t image/png -i $f'"
  --   awful.spawn.easy_async(cmd, function() end)
