...
M.setup = function()
    ...
    require("fzf-lua").setup({
        ...
        winopts = {
            ...
            preview = {
                default = "bat", -- use bat to preview files
        ...
        previewers = {
            ...
            bat = {
                ...
                theme = "Coldark-Dark", -- bat preview theme (bat --list-themes) --TODO
        ...
        colorschemes = {
            ...
            actions = {
                ["default"] = function(selected)
                    ...
                    require("utils").sad("05", vim.g.Theme, colorscheme, "~/.config/nvim/init.lua")
                end,
            },
            ...
            post_reset_cb = function()
                ...
                -- require('feline').reset_highlights() -- TODO here can call heirline's on_colorscheme
            end,
        },
        quickfix = {
            file_icons = true,
